  ...
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-gradient-to-tr from-black via-green-800 to-black">
      ...
      <div className="grid grid-cols-3 gap-6 p-4">
        {tracks.length > 0 ? <div className="col-start-2 justify-self-center"><TrackList tracks={tracks}/></div> : <div className="col-start-2 justify-self-center h-80"><p className="text-3xl font-bold text-green-600">Select a mood and click "Get Playlist" to start!</p></div>}
        <div className="col-start-3 text-center mt-4 text-gray-300">
          ...
          <p className="text-gray-400 text-center mt-4">Powered by Spotify API</p>
